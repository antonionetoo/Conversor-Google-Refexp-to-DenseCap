...
class ConverterGRefToDenseCap:
   ...
   def __init__(self, path_train_json, path_val_json):
      ...
      self._copier              = copy_image.CopierImagem()
   ...
   def convert_json(self, copy_images = False, sufixo_nome = ""):
      ...
      print('*********** saving jsons')
      help_json.save_json('../json/google_refexp%s.json'%(sufixo_nome), self._refexps)
      help_json.save_json('../json/split%s.json'%(sufixo_nome), split)
...
def main():
   ...
   parser.add_argument('-path_train_json', default = '../google_refexp_dataset_release/google_refexp_train_201511_coco_aligned.json',
         type = str, help = 'Aligned training file path')
   
   parser.add_argument('-path_val_json', default = '../google_refexp_dataset_release/google_refexp_val_201511_coco_aligned.json', 
         type = str, help = 'Aligned validation file path')

   parser.add_argument('-copy_images', default = 'n', type = str,
         help = 'Copy renaming images')
   
   parser.add_argument('-images', default = 'n', type = str,
         help = 'Folder for copying images')
   ...
   conversor.convert_json(sufixo_nome = suffix_file, 
             copy_images = (True if args.copy_images == 's' else False ))
